...
def getDbQueryResult(dbCommand = None, dbIp=Global.XiaoFangInfo['DbIp'], dbInstance=Global.XiaoFangInfo['DbInstance'], dbUser=Global.XiaoFangInfo['DbUser'], dbPass=Global.XiaoFangInfo['DbPass']):
...
def getDbQueryResultList(dbCommand = None, dbIp=Global.XiaoFangInfo['DbIp'], dbInstance=Global.XiaoFangInfo['DbInstance'], dbUser=Global.XiaoFangInfo['DbUser'], dbPass=Global.XiaoFangInfo['DbPass']):
    os.environ['NLS_LANG'] = 'SIMPLIFIED CHINESE_CHINA.UTF8'
    conn = cx_Oracle.connect(dbUser, dbPass,"%s:1521/%s" % (dbIp,dbInstance))
    #conn = cx_Oracle.connect(dbUser, dbPass,"%s:21521/%s" % ('anhaooray.oicp.net',dbInstance))
    cursor = conn.cursor()
...
def getIdByDomainAndDisplayName(domainName = None,displayName = None, databaseIp = Global.XiaoFangInfo['DbIp'], databaseInstance=Global.XiaoFangInfo['DbInstance'], databaseUser=Global.XiaoFangInfo['DbUser'], databasePass = Global.XiaoFangInfo['DbPass']):
    os.environ['NLS_LANG'] = 'SIMPLIFIED CHINESE_CHINA.UTF8'
...
def getOrgInfoByAccount(account = None,databaseIp = Global.XiaoFangInfo['DbIp'], databaseInstance=Global.XiaoFangInfo['DbInstance'], databaseUser=Global.XiaoFangInfo['DbUser'], databasePass = Global.XiaoFangInfo['DbPass']):
    orgInfo = {'orgId':None,
               'orgName':None,
