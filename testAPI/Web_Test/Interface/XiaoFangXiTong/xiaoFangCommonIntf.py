...
def getDbQueryResult(dbCommand = None, dbIp=Global.ShengXiaoFangXiTongDbIp, dbInstance=Global.ShengXiaoFangXiTongDbInstance, dbUser=Global.ShengXiaoFangXiTongDbUser, dbPass=Global.ShengXiaoFangXiTongDbPass):
...
def getDbQueryResultList(dbCommand = None, dbIp=Global.ShengXiaoFangXiTongDbIp, dbInstance=Global.ShengXiaoFangXiTongDbInstance, dbUser=Global.ShengXiaoFangXiTongDbUser, dbPass=Global.ShengXiaoFangXiTongDbPass):
    os.environ['NLS_LANG'] = 'SIMPLIFIED CHINESE_CHINA.UTF8'
    conn = cx_Oracle.connect(dbUser, dbPass,"%s:1521/%s" % (dbIp,dbInstance))
    #conn = cx_Oracle.connect(dbUser, dbPass,"%s:21521/%s" % ('anhaooray.oicp.net',dbInstance))
    cursor = conn.cursor()
...
def getIdByDomainAndDisplayName(domainName = None,displayName = None, databaseIp = Global.ShengXiaoFangXiTongDbIp, databaseInstance=Global.ShengXiaoFangXiTongDbInstance, databaseUser=Global.ShengXiaoFangXiTongDbUser, databasePass = Global.ShengXiaoFangXiTongDbPass):
    os.environ['NLS_LANG'] = 'SIMPLIFIED CHINESE_CHINA.UTF8'
...
def getOrgInfoByAccount(account = None,databaseIp = Global.ShengXiaoFangXiTongDbIp, databaseInstance=Global.ShengXiaoFangXiTongDbInstance, databaseUser=Global.ShengXiaoFangXiTongDbUser, databasePass = Global.ShengXiaoFangXiTongDbPass):
    orgInfo = {'orgId':None,
               'orgName':None,
